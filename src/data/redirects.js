export const REDIRECTS = [
  ...
  { from: '/iphone', to: '/catalog/smartphones' },
  { from: '/mac', to: '/catalog/laptops' },
  { from: '/ipad', to: '/catalog/tablets' },
  { from: '/watch', to: '/catalog/watches' },
  ...
  { from: '/catalog/ipad', to: '/catalog/tablets' },
